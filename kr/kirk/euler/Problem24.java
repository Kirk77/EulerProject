...
//		System.out.println(Problem24.solution(1000000));
	...
	private static String solution(int x) {
		...
		return getNumber(card, x, 0);
	}
	
	
	private static String getNumber(List<Integer> card, int x, int sum) {
		...
		return String.valueOf(ii) + getNumber(card, x, sum);
	}
