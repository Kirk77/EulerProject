...
public class Problem055 {
	...
	private static BigInteger reverse(BigInteger b) {
		StringBuffer sb =  new StringBuffer(b.toString());
		return new BigInteger(sb.reverse().toString());
	}

	private static boolean isPanlindrome(BigInteger temp) {
		
		byte[] sz =  temp.toString().getBytes();
